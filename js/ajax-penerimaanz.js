...
(function($, window, undefined){
    $(document).ready(function(){
        ...
        $(document).on("click", ".data-order", function () {
            ...
            $.get('penerimaans/' + id_order+'/'+no_order, function (data) {
            ...
            var no_order = $(this).val();
                            ...
                            var detail = new DevExpress.data.CustomStore({
                              ...
                              load: function(loadOptions) {
                                ...
                                $.getJSON('details/getalat/'+id_order+'/'+no_order, params).done(function (data) {
