...
function get_detail_order(petugas_lab){
    ...
    var petugas_lab=petugas_lab;
        ...
        var $tableorder = jQuery("#tableorder");
            ...
            processing: true,
            serverSide: true,
            ajax: "penyerahan/getorder/"+id_order+"/"+petugas_lab,
            columns: [
                { data: 'id', name: 'id' },
                { data: 'alat', name: 'alat' },
                { data: 'seri', name: 'seri' },
        ...
        $(document).on("click", ".open-modal", function () {
            ...
            $.get(url + '/' + id, function (data) {
                ...
                var $tableorder = jQuery("#tableorder");
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: "penyerahan/getorder/"+data.id_order+"/"+data.petugas_lab,
                    columns: [
                        { data: 'id', name: 'id' },
                        { data: 'alat', name: 'alat' },
                        { data: 'seri', name: 'seri' },
